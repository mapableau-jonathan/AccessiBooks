...
// Check for PayPal credentials but don't crash if missing
...
if (paypalEnabled) {
  ...
  console.log("PayPal integration not configured - missing credentials");
}

/* Token generation helpers */

export async function getClientToken() {
  if (!paypalEnabled || !oAuthAuthorizationController) {
...
export async function createPaypalOrder(req: Request, res: Response) {
  if (!paypalEnabled || !ordersController) {
